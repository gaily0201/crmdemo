...
<body>
	<s:form name="ActionForm"  action="linktouchAction_update.do" namespace="/crm" onSubmit="check();">
		<div class="control">
		...
		<%-- 	<button type='button' class='button'
				...
				<img
					src="${pageContext.request.contextPath}/ui/images/button/daoshouye.png"
					border='0' align='absmiddle'>&nbsp;上一个
			</button>
			<button type='button' class='button'
				onMouseOver="this.className='button_over';"
				onMouseOut="this.className='button';"
				...
				<img
					src="${pageContext.request.contextPath}/ui/images/button/daoweiye.png"
					border='0' align='absmiddle'>&nbsp;下一个
			</button> --%>
		</div>
