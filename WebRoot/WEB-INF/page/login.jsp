...
<s:form name="form1" method="post" action="sysUserAction_isLogin" namespace="/sys">
		...
		<TD width="540" valign="top">
		  ...
		  <TR>
			  ...
			  <TR>
			  	<TD class="td">登录密码：</TD>
			  	<TD class="td">
			  		<input name="password" type="password" value="<%= psw %>" id="password"></TD>
			  </TR>
			  <TR>
			  	<TD class="td">验&nbsp;证&nbsp;码：</TD>
			  	<TD class="td"><input name="checkNum" type="text" value="" id="checkNum" checked=<%=checked%> style="width: 80">
			  ...
			  <TR>
			  	...
			  	<TD class="td">
			  		<input name="rememberMe" type="checkbox" id="rememberMe" value="yes" checked="checked" class="checkbox">
