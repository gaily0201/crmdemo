...
<body>
	<s:form name="form1" method="post"
		action="sys/sysUserGroupAction_save.do" namespace="/sys">
					...
					<div id="menu1">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td><s:textfield name="name" cssClass="input"
										cssStyle="width:90%" />
								</td>
							...
							<tr>
								...
								<td colspan="3"><s:textarea name="incumbent" rows="3"
										cssStyle="width:96%" />
								</td>
							</tr>
							<tr>
								<td height="40" valign="top">备注</td>
								<td colspan="3"><s:textarea name="remark" rows="3"
