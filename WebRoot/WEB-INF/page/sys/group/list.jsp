...
<body>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabForm">
		...
		<tr>
			<td colspan="2">
				<s:form name="form1" method="post" action="sys/sysUserGroupAction_list.do" namespace="/sys">
	...
	<div class="border">
		...
		<s:form name="form2" method="post"
			action="sys/sysUserGroupAction_delete.do" namespace="/sys">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<s:if test="%{#request.sysUserGroups!=null}">
					<s:iterator value="%{#request.sysUserGroups}" var="sysUserGroup">
						<tr>
							<td>
								<s:checkbox name="ids" cssClass="checkbox" onclick="changeCheckCount();" fieldValue="%{#sysUserGroup.id}"/>
							</td>
							<td>
								<a href="${pageContext.request.contextPath}/sys/sysUserGroupAction_edit.do?id=<s:property value="%{#sysUserGroup.id}"/>"><s:property value="%{#sysUserGroup.name}" /></a>
							</td>
							<td>
