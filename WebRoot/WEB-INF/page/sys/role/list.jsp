...
<body>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			<td colspan="2"><s:form name="searchForm" method="post"
					action="sysRoleAction_list.do" namespace="/sys">
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						name="base" id="base">
						<tr>
							<td width="38%" nowrap>名称： <input name="name" type="text"
	...
	<div class="border">
		<s:form name="ActionForm" method="post"
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<!-- title -->
				<tr>
					<td width="6%" class="listViewThS1"><input type="checkbox"
				...
				<s:if test="%{#request.sysRoles!=null}">
					<s:iterator value="%{#request.sysRoles}" var="sysRole">
						<tr>
							<td>
								<s:checkbox name="ids" cssClass="checkbox" onclick="changeCheckCount();" fieldValue="%{#sysRole.id}" />	
							</td>
